    ...
    public class FetchTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                URL url = null;
                try {
                    url = new URL(new AddrUtil().getAddress("GetFollower"));
                ...
                response = client.sendToServer(new Pack(Information.GET_FOLLOWER, user.getId()));
            } catch (Exception e) {
                e.printStackTrace();
            }
            return true;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            try {
                ...
                adapter = new ListAdapter(FollowerActivity.this, users);
